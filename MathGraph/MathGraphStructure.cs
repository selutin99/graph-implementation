...
namespace MathGraph
{
    ...
    class DrawGraph
    {
        ...
        //Метод заполняет матрицу смежности
        ...
        //Метод заполняет матрицу смежности (для степеней)
        public void fillAdjacencyMatrixForDeg(int numberV, List<Edge> E, int[,] matrix)
        {
            for (int i = 0; i < numberV; i++)
                for (int j = 0; j < numberV; j++)
                    matrix[i, j] = 0;
        ...
        //Метод заполняеты матрицу инцидентности
